...
export default function Footer({ tagline, instagramUrl, facebookUrl }: FooterProps) {
  return (
    <footer className="footer" id="footer">
      <div className="footer-brand">Primitivo Grill</div>
      ...
      <div className="footer-bottom">
        <div className="footer-copy">&copy; {new Date().getFullYear()} Primitivo Grill. All rights reserved.</div>
        <div className="footer-hashtag">#CraftedAtPrimitivo</div>
      </div>
    </footer>
  )
}
